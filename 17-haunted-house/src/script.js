...
import { BoxGeometry, ConeGeometry, Float32BufferAttribute, Fog, Group, Mesh, MeshStandardMaterial, PlaneGeometry, PointLight, SphereGeometry } from 'three'
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('gray', 2, 3)
scene.add(ghost1)

const ghost2 = new THREE.PointLight('#5A5A5A', 2, 3)
scene.add(ghost2)
